package com.example.framgiatrieuvanthan.mvpexample3.data.preference;
...
public class StorageUtil {
    ...
    private final String STORAGE = "com.example.framgiatrieuvanthan.mvpexample3.data.STORAGE";
